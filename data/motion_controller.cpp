...
public:
  ...
  : transform_listener_(ros::Duration(10))
  {
    ...
    // Subscribers
    simple_goal_subscriber_ = pn.subscribe<geometry_msgs::PoseStamped>("/move_base_simple/goal", 1, boost::bind(&MotionControllerNode::simpleGoalCallback, this, _1));
...
private:
  ...
  void createVelocityController()
  {
    ...
    else
    {
      ...
      velocity_controller_ = VelocityController::UPtr(new OmniVelocityController(
                                max_linear_velocity, max_angular_velocity, max_linear_acceleration, linear_tolerance, angular_tolerance));
